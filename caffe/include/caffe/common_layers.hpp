...
class SelectiveProductLayer : public Layer<Dtype>{
 public:
  explicit SelectiveProductLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "SelectiveProduct"; }
...
//      const vector<bool>& propagate_down, const vector<Blob<Dtype>*>& bottom);
  ...
  int P_; //total number of inner products to make 
  ...
  int b_index_; 
  int s_index_;
  //these encode our connectivity, i connections.
  //the goal is to compute:
  //output_[i] = input_[i]'*param_[i]
  //Blob<int> input_;
  //Blob<int> param_;  
  Blob<int> output_;
  ...
  //we need three sorted lists, one for each parameter set  
  Blob<int> output_kindex_;
  Blob<int> output_pindex_;
  Blob<int> output_iindex_;

  Blob<int> param_kindex_;
  Blob<int> param_oindex_;
  Blob<int> param_iindex_;

  Blob<int> input_kindex_;
  Blob<int> input_oindex_;
  Blob<int> input_pindex_; 
