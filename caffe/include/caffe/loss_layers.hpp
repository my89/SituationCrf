...
template <typename Dtype>
class MILFrameIndLossLayer : public LossLayer<Dtype> {
 public:
  explicit MILFrameIndLossLayer(const LayerParameter& param)
      : LossLayer<Dtype>(param) {}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
  ...
  virtual inline const char* type() const { return "MILFrameIndLoss"; }
 ...
 protected:
  ...
  Blob<Dtype> contradiction_scores;
  Blob<Dtype> total_negative_scores;
...
template <typename Dtype>
class FrameLossLayer : public LossLayer<Dtype> {
 public:
  explicit FrameLossLayer(const LayerParameter& param)
      : LossLayer<Dtype>(param) {}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
  ...
  virtual inline const char* type() const { return "FrameLoss"; }
  virtual inline int ExactNumTopBlobs() const { return 3; }
  virtual inline int ExactNumBottomBlobs() const { return -1;}

 protected:
  virtual void PredictMarginalObject(const vector<Blob<Dtype>*>& bottom, const vector<Blob<Dtype>*>& top);
  virtual void PredictMarginalFrame(const vector<Blob<Dtype>*>& top);
...
template <typename Dtype>
class FullRowFrameAccuracyLayer : public Layer<Dtype> {
 public:
  explicit FullRowFrameAccuracyLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
  ...
  virtual inline const char* type() const { return "FullRowFrameAccuracy"; }
  virtual inline int ExactNumBottomBlobs() const { return 1; }
...
template <typename Dtype>
class ObjectFrameAccuracyLayer : public Layer<Dtype> {
 public:
  explicit ObjectFrameAccuracyLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
  ...
  virtual inline const char* type() const { return "ObjectFrameAccuracy"; }
  virtual inline int ExactNumBottomBlobs() const { return 2; }
  //output top-1 and top-5 accuracy
  virtual inline int ExactNumTopBlobs() const { return 1; }
