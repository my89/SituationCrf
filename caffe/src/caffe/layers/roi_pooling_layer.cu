...
/*  Dtype* top_data_cpu = top[0]->mutable_cpu_data();
  for(int i = 0; i < 100; i++){
    LOG(INFO) <<"0,"<<i<<":"<<top_data_cpu[i*49*512];
    LOG(INFO) <<"1,"<<i<<":"<<top_data_cpu[i*49*512 +1];
    LOG(INFO) <<"2,"<<i<<":"<<top_data_cpu[i*49*512 +2];
    LOG(INFO) <<"3,"<<i<<":"<<top_data_cpu[i*49*512 +3];
  }
*/
}
...
*/
//  const Dtype* bottom_rois2 = bottom[1]->cpu_data();
//  LOG(INFO) << bottom_rois2[1].shape(0) << "," << bottom[1].shape(1);
//  LOG(INFO) << "rois:" << bottom_rois2[0] << "," << bottom_rois2[1] << "," << bottom_rois2[2] << "," << bottom_rois2[3] << "," << bottom_rois2[4];
